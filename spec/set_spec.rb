...
describe SetGame::Set do
  ...
  it 'knows if one feature of a set is the same for all cards' do
    ...
    expect(SetGame::Set.feature_the_same_for_all_cards(:count, cards))
      .to eq(false)
    expect(SetGame::Set.feature_the_same_for_all_cards(:color, cards))
      .to eq(true)
    expect(SetGame::Set.feature_the_same_for_all_cards(:shape, cards))
      .to eq(true)
  end
  it 'knows if one feature of a set is different for all cards' do
    ...
    expect(SetGame::Set.feature_different_for_all_cards(:count, cards))
      .to eq(true)
    expect(SetGame::Set.feature_different_for_all_cards(:color, cards))
      .to eq(false)
    expect(SetGame::Set.feature_different_for_all_cards(:shape, cards))
      .to eq(false)
  end
  it 'knows if one feature of a set is either the same or different for all'\
    ...
    expect(SetGame::Set
      .feature_the_same_or_different_for_all_cards?(:count, cards)).to eq(true)
    expect(SetGame::Set
      .feature_the_same_or_different_for_all_cards?(:color, cards)).to eq(false)
    expect(SetGame::Set
      .feature_the_same_or_different_for_all_cards?(:fill, cards)).to eq(true)
  end
end
